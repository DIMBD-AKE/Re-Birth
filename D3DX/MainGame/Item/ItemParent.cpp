...
bool ItemParent::Skill1(CharacterParant* pCharacter, MonsterManager* pMonsterManager, Map* map)
{
	...
	{
		m_pSkill1->Prepare(pCharacter, pMonsterManager->GetMonsterVector()[0], pMonsterManager, *m_Skill1Data, SKILLO_CHARACTER);
		m_pSkill1->Trigger();
...
bool ItemParent::Skill2(CharacterParant* pCharacter, MonsterManager* pMonsterManager, Map* map)
{
	...
	{
		m_pSkill2->Prepare(pCharacter, NULL, pMonsterManager, *m_Skill2Data, SKILLO_CHARACTER);
		m_pSkill2->Trigger();
