...
void SC_Loading::AddTexture()
{
	...
	m_pLoading->LoadTexture("콤보", "Texture/Effect/combo.png");
...
void SC_Loading::AddParticle()
{
	...
	m_pLoading->LoadParticle("Meteor", "MeteorAfter", "Particle/meteor.ptc");
	...
	m_pLoading->LoadParticle("리아_궁극기", "Particle Sphere", "Particle/riah_final.ptc");
}
